...
import { cartoons } from "./strings/cartoons";
...
export const mn = {
  ...
  home: {
    ...
    dueToday: "Сурсан ханзнууд болон үгнүүд",
    dueWordsCount: "Нийт {n} үг, ханзаа цээжилсэн",
    noDue: "Одоогоор сурсан үг алга — хичээлээс эхлэнэ үү",
    ...
    learnLessonsTitle: "Learn",
    continueLessonKicker: "Үргэлжлүүлэх",
    learnedLexiconKanji: "Сурсан ханз",
    learnedLexiconWords: "Сурсан үгс",
    learnedLexiconLogin: "Нэвтэрснээр сурсан ханз болон үгээ энд харна.",
  },
  study,
  games,
  cartoons,
  ...
  profile: {
    ...
    legalSectionTitle: "Бодлого ба өгөгдөл",
    privacyPolicy: "Нууцлалын бодлого",
    termsOfService: "Үйлчилгээний нөхцөл",
    deleteAccount: "Бүртгэл устгах",
    deleteAccountSubtitle:
      "Бүртгэл устгаснаар профайл, явц зэрэг сервер дээрх өгөгдөл устгагдана (өөрийн тохиргооны дагуу).",
    ...
    seenWords: "Үзсэн үгс",
    seenWordsHint:
      "Хичээл болон давталтаар орсон үгс — ханз, дуудлага, зураас.",
  ...
  admin: {
    ...
    hsk1LessonsListHint:
      "Сурагчийн жагсаалттай ижил дараалал; хичээл бүрийг засна.",
    hsk1LessonsTitle: "HSK 1 хичээлүүд",
    hsk1LessonsEmpty: "HSK 1 бүлэг олдсонгүй.",
    dashScreenIntro:
      "Доорх хүснэгт нь HSK-ээр үг, бүлэг, хичээлийн задаргаа. Дээш талын тоог нүүрнээс харна.",
    smFlashcard:
      "Дахин давтах оочер (SRS) болон хичээлээс үүссэн «Өнөөдөр»-ийн үг.",
    ...
    smWriter:
      "Нэг ханз зурах — энд нэг ханзны үг оруул (зураасны дарааллыг апп тооцно).",
    smSpeak: "Дуутай давтах — хятад дуу серверийн TTS; орчуулгыг апп уншина.",
    smGrammar:
      "Дүрмийн агуулга нь курс/скриптээр; энд бүлэг, хичээлийн удирдлага.",
    smMock:
      "Шалгалтын агуулга тусдаа; суралцах замаар хичээлүүдийг бэлэн болгоно.",
    ...
    bulkSharedExampleHint:
      "Оруулсан жишээг олон-мөрийн зөв мөр бүрэнд ижилхэн хадгалана.",
