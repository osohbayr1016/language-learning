-- Re-apply HSK1 path if missing (safe when 0006 already ran: INSERT OR IGNORE).
...
INSERT OR IGNORE INTO lessons (id, chapter_id, title_mn, subtitle_mn, icon, order_num, is_published) VALUES
...
INSERT OR IGNORE INTO lesson_words (lesson_id, word_id, order_num) VALUES
  (1, 1, 1), (1, 2, 2), (1, 3, 3),
